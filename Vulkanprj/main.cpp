...
private:
	...
	void initWindow() {
		...
		// glfw를 OPenGL 대신 Vulkan에서 사용하기 위해 설정
	...
	void createInstance() {
		...
		// appInfo를 기반으로 vk인스턴스 인포 만들기
		VkInstanceCreateInfo createInfo{};
		createInfo.sType = VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO;
		createInfo.pApplicationInfo = &appInfo;

		// Hardcoding 방식 -> getRequireExtensions() 구현해서 호출
